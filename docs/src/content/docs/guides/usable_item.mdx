...
2. Add your model to the `pack/assets/kanoho/models/item` directory, and any textures to the `pack/assets/kanoho/textures/item` directory.
    Make sure to follow our [naming conventions](/guides/getting_started#naming-conventions).
...
2. Add a cooldown to the item by adding the `minecraft:use_cooldown` component.
    ...
    ```
    `seconds` is the duration of the cooldown in seconds, and `cooldown_group` is a unique identifier for the cooldown. Make sure to follow our [naming conventions](/guides/getting_started#naming-conventions) for the cooldown group.
...
Open mcfunction-server using the `/editor` command and create a new function. Make sure to follow our [naming conventions](/guides/getting_started#naming-conventions) for the function name, such as `doc/party_popper/used`.
